{ self, inputs, ... }: {
  flake.nixosModules.desktopConfig = { pkgs, lib, config, ... }: {
    imports = [
    ...
    sops.secrets.aws-access-key-id = { owner = "sean"; };
    sops.secrets.aws-secret-access-key = { owner = "sean"; };
    ...
    fileSystems."/mnt/media" = {
      ...
      fsType = "nfs";
      options = [ "nfsvers=4" "soft" "timeo=30" "noauto" "x-systemd.automount" ];
    };
    ...
    home-manager = {
      ...
      users.sean = { config, pkgs, lib, ... }: {
        ...
        gtk.cursorTheme = { name = "Breeze_Light"; size = 24; };
