# modules/features/desktop/communications.nix
{ self, ... }: {
  flake.homeManagerModules.communications = { config, pkgs, ... }: {
    programs.thunderbird = {
      enable = true;
      profiles."default".isDefault = true;
    };

    home.sessionVariables.THUNDERBIRD_HOME = "${config.xdg.configHome}/thunderbird";
    ...
    accounts.email.accounts = {
      ...
      "chudstop" = {
        ...
        realName = "admin";
        imap = { host = "mail.cock.li"; port = 993; tls.enable = true; };
        smtp = { host = "mail.cock.li"; port = 465; tls.enable = true; };
